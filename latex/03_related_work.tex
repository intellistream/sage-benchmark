...
batching, KV-cache management, and GPU utilization (e.g., sageLLM and related systems
\cite{kwon2023pagedattention,orcaserving,sarathi,tensorrt_llm,fastertransformer}). Industrial serving stacks (e.g., Triton
