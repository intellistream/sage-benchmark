...
\begin{itemize}
  \item \textbf{L5 Interface}: Developer-facing CLI, applications, and benchmark runners built on top of the consolidated core.
  \item \textbf{L4 Adapters}: Optional vector, memory, and refinement adapters such as SageVDB, NeuroMem, and related external services.
  \item \textbf{L3 Core}: The consolidated \texttt{isage} runtime and stream stack responsible for dataflow scheduling,
        operator execution, and fault tolerance.
  \item \textbf{L2 Runtime Services}: Shared infrastructure for environments, schedulers, queue abstractions, and service lifecycle management.
  \item \textbf{L1 Foundation}: Core utilities, configuration management, type definitions, ports, and logging interfaces.
\end{itemize}
