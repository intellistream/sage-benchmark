...
vector search, memory reads/writes across turns, context refinement under token budgets, and tool calls with
...
\paragraph{Why existing systems fall short.}
...
refinement---all exposed through uniform dataflow operators. For LLM inference, SAGE leverages sageLLM as
